goog.require('THREE.BoxGeometry');
goog.require('THREE.Mesh');
goog.require('THREE.MeshBasicMaterial');
goog.require('THREE.Octree');
goog.require('THREE.PerspectiveCamera');
goog.require('THREE.Raycaster');
goog.require('THREE.Scene');
goog.require('THREE.SphereGeometry');
goog.require('THREE.Vector3');
goog.require('THREE.WebGLRenderer');
